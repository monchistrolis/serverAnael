...
async function initializeHandlers({ reader, writer, logger, options, }) {
    try {
        const connection = (0, vscode_languageserver_1.createConnection)(reader, writer);
...
async function addHandlers({ connection, logger, config, parser, fileExtensions, graphqlFileExtensions, tmpDir, loadConfigOptions, }) {
    ...
    connection.onNotification(vscode_languageserver_1.DidChangeConfigurationNotification.type, params => messageProcessor.handleDidChangeConfiguration(params));
}
